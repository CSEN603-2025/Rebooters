...
function showUploadForm(id) {
    ...
    document.getElementById('applyForm').onsubmit = function(e) {
        ...
        if (apps.some(app => app.internshipId === id && app.user === user)) {
            document.getElementById('applyMessage').textContent = "You have already applied for this internship.";
            return;
        }
        ...
        document.getElementById('applyMessage').textContent = "Application submitted successfully!";
