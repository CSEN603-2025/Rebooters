        ...
        case 'student':
            ...
            html = `
                <ul>
                    ...
                    <button onclick="window.location.href='my-internships.html'">My Internships</button>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (savedClosedNotifications) {
        try {
            ...
            // Handle both old format (array) and new format (object with keys and timestamp)
